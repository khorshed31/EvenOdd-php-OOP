                           ...
                           <div class="card-body">
                               <form action="action.php" method="post">
                                   <div class="form-group row">
                                       ...
                                       <div class="col-md-9">
                                           <input type="number" class="form-control" name="s_num" value=""/>
                                       </div>
                                   </div>
                                   ...
                                   <div class="form-group row">
                                       ...
                                       <div class="col-md-9">
                                           <input type="number" class="form-control" name="e_num" value=""/>
                                       </div>
                                   </div>
                                   ...
                                   <div class="form-group row">
                                       ...
                                       <div class="col-md-9">
                                           <label><input type="radio" name="even_odd" value="even"/> Even</label>
                                           <label><input type="radio" name="even_odd" value="odd"/> Odd</label>
                                       </div>
                                   </div>
